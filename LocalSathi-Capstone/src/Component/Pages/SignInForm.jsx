...
let navigate = useNavigate()
 ...
 const   submitbtn = (e) => {
    ...
    axios.post("http://localhost:3200/login", { Name: name, Age: Age, Email: Email, Password: password })
    .then((res) => {
  ...
  <form className="form">
    ...
    <div className="flex-column">
      ...
      <div className="inputForm">
        ...
        <input type="text" className="input" name='UserEmail' onChange={(e) => setUSerEmail(e.target.value)} placeholder="Enter your Email" />
      </div>
    </div>
    ...
    <div className="flex-column">
      ...
      <div className="inputForm">
        ...
        <input type="password" className="input" name='UserPassword' onChange={(e) => setUSerPassword(e.target.value)} placeholder="Enter your Password" />
